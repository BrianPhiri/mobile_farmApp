...
public class FarmerOrderListAdapter extends RecyclerView.Adapter<FarmerOrderListAdapter.ViewHolder>{
    private static final int LENGTH = 18;
    Context context;
    public List<String> ordersDataTitle;
    public List<String> ordersDataDescription;

    public FarmerOrderListAdapter(FragmentActivity activity, List<String> ordersDataDescription, List<String> ordersDataTitle) {
    ...
    @Override
    public FarmerOrderListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new FarmerOrderListAdapter.ViewHolder(LayoutInflater.from(parent.getContext()), parent);
    }

    @Override
    public void onBindViewHolder(FarmerOrderListAdapter.ViewHolder holder, int position) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(R.layout.fragment_orders_farmer_list, parent, false));
